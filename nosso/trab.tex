...
\section{Fundamentos básicos sobre software livre}\label{Fundamentos básicos sobre software livre}
...
Os softwares citados nas seções abaixo, seguem a filosofia Unix\cite{filosofia_unix}, que teria como um dos princípios ``Faça cada programa fazer uma coisa bem feita\cite{filosofia_unix}'', para diversas áreas do conhecimento.
